...
# Physical constants
grav_const = 4.0 * np.pi**2  # in AU^3 yr^-2 solar_mass^-1
c = 2.998e8 / 1.496e11 * 365.25 * 24.0 * 60.0 * 60.0  # AU yr^-1
planck = 6.62608e-27
...
# File paths
exovistapath = "./"
lqq_dir = resources.files("ExoVista").joinpath("data/lqq_files/")
# lqq_dir = "lqq_files/"
...
master_rdust_boundaries = np.array(
    [
        0.1000,
        0.1216,
        0.1480,
...
master_drdust = (
    master_rdust_boundaries[1:master_nsizes]
    - master_rdust_boundaries[0 : master_nsizes - 1]
)
...
# FITS file comments
scomments = {
    "PA": "System midplane position angle (deg)",
